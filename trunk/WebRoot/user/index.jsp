	...
	<body id="indexBody" onload="myStmtAjax.getNewStmt()">
		...
		<div id="mainPanel">
			...
			<div id="global_toolbox">
				<ul id="linkBox">
					<li>
						<button id="linkButton_friend"></button>
					</li>
					<li>
						<button id="linkButton_album"></button>
					</li>

					<li>
						<button id="linkButton_blog"></button>
					</li>
				</ul>
				<ul id="systemMessageBox">
					...
					<s:iterator value="#session.placards" var="placard" status="i">
						<li>
							<div id='placard_<s:property value="#placard.idPlacard"/>'
								class="div_placard">
						...
						<s:iterator value="#session.mails" var="mail">
							<li id='li_<s:property value="#mail.id" />'>
								<s:if test="#mail.title == 'Friends Request'">
									<a
										href='home.action?userId=<s:property value="#mail.fromUser.idUser"/>'>
										<s:property value="#mail.fromUser.userName" /> </a>
									<span> <s:text name="index.addrequest"></s:text> </span>
									<label
										id='add_<s:property value="#mail.fromUser.idUser"/>_<s:property value="#mail.id" />'
						...
						<s:iterator value="#session.msg" var="message">
							<li class="content_item">
  	  						...
  	  						<s:param name="userId" value="#message.owner.idUser"></s:param></s:url>'
											...
											<!--Replys-->
											<div class="replyDiv"
												id='replyDiv_<s:property value="#message.item.idItem"/>'>
									...
									<div class="replySelf" style="display: none"
										...
										<br>
										<input
											id='btn_reply_<s:property value="#message.item.idItem"/>'
											type="button" value='<s:text name="index.return"/>'
											onclick="replyAjax.replyBtn(this.id)" />
										<label
											id='replyRemain_reply_<s:property value="#message.item.idItem"/>'>
											150
										</label>
										/150
  	  						...
  	  						<s:param name="userId" value="#message.owner.idUser"></s:param></s:url>'
														...
														<a
															href='showBlog.action?id=<s:property value="#message.msgId"/>&&state=show'>
															<s:property value="#message.title" /> </a>
													</h3>
												</p>
