...
public class StatementService implements IStatementService {
	 ...
	 * 
	 * @param userId the user id which you want to get his or her latest statement.
	 ...
	 * 
	 * @param userId the id of the user's statement.
	 * @param deadline the limited time of the needed statement.
