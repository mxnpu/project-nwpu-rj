...
<label class="labelFont1">Add Public Information</label>
        ...
        <table width="512">
            <tr>
              ...
              <td width="382"><label>
              <input name="placardDTO.title" type="text" value="<s:property value="placard.title"/>"  maxlength="16" required="ture" size="50"/>
              </label></td>
            </tr>
            <tr>
              <td height="204" valign="top">Content:</td>
              <td><label>
              <textarea name="placardDTO.content" cols="50" rows="14"><s:property value="placard.content"/></textarea>
              </label></td>
            </tr>
        </table>
        <table width="460">
